...
const cards = [
  {
    data: [
      ...
      },
      {
        ...
        appeardManga: '2',
        appeardAnime: '1',
        clowCard: 'https://i.ibb.co/nkySYwk/Vuelo.jpg',
      ...
      },
      {
        ...
        meaning:
          'Simboliza la repetición de algo pasado, el mirar hacia atrás.',
        __v: 0,
        cardsReverse: {
          clowReverse: 'https://i.ibb.co/LJSmQ4f/Reverso-Clow.jpg',
          sakuraReverse: 'https://i.ibb.co/XxrvMJ2/Reverso-Sakura.jpg',
      ...
      },
      {
        ...
        meaning:
          'Simboliza el bloqueo, la inmovilidad y el fin de los problemas.',
        __v: 0,
        cardsReverse: {
          clowReverse: 'https://i.ibb.co/LJSmQ4f/Reverso-Clow.jpg',
          sakuraReverse: 'https://i.ibb.co/XxrvMJ2/Reverso-Sakura.jpg',
      ...
      },
      {
        ...
        meaning:
          ' Simboliza el futuro, la adivinación, los sueños premonitorios.',
        __v: 0,
        cardsReverse: {
          clowReverse: 'https://i.ibb.co/LJSmQ4f/Reverso-Clow.jpg',
          sakuraReverse: 'https://i.ibb.co/XxrvMJ2/Reverso-Sakura.jpg',
      ...
      },
      {
        ...
        meaning:
          'Simboliza lo oculto, lo que aún está por descubrir, la ventaja.',
        __v: 0,
        cardsReverse: {
          clowReverse: 'https://i.ibb.co/LJSmQ4f/Reverso-Clow.jpg',
          sakuraReverse: 'https://i.ibb.co/XxrvMJ2/Reverso-Sakura.jpg',
      ...
      {
        _id: '603a8aeb3da2c60015bd6940',
        cardNumber: 53,
        spanishName: 'El Amor',
        englishName: 'The Love',
        kanji: '愛',
        Rōmaji: 'Ai',
        appeardManga: '',
        appeardAnime: '70',
        clowCard: '',
        sakuraCard: 'https://i.ibb.co/tpKcyp0/Amor.jpg',
        meaning: ' Representa el amor y la amistad.',
        __v: 0,
        cardsReverse: {
          sakuraReverse: 'https://i.ibb.co/XxrvMJ2/Reverso-Sakura.jpg',
        },
      ...
      {
        _id: '618a0cc5c0e81c0016b8c3a3',
        __v: 0,
      },
      {
        _id: '618a0cd2c0e81c0016b8c3a4',
        __v: 0,
      },
      {
        _id: '618a0cd4c0e81c0016b8c3a5',
        __v: 0,
      },
      {
        _id: '618a0cd5c0e81c0016b8c3a6',
        __v: 0,
      },
      {
        _id: '618a0cd7c0e81c0016b8c3a7',
        __v: 0,
      },
    ],
    page: 1,
...
test('renders detail when routing', async () => {
  render(
    <MemoryRouter initialEntries={['/6039396a68347a4a842920cf']}>
      <Route path="/:_id">
        <Card />
      </Route>
    </MemoryRouter>
  );
  const item = await screen.findByText('Spanish Name: Viento');
  expect(item).toBeInTheDocument();
});

test('goes back to home loading', async () => {
  render(
    <MemoryRouter initialEntries={['/6039396a68347a4a842920cf']}>
      <Route path="/:_id">
        <Card />
